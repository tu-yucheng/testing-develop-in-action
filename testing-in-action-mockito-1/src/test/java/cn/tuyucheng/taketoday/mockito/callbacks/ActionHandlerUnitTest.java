...
class ActionHandlerUnitTest {
    ...
    @Test
    @DisplayName("givenServiceWithValidResponse_whenCallbackReceived_thenProcessed")
    ...
    @Test
    @DisplayName("givenServiceWithInvalidResponse_whenCallbackReceived_thenNotProcessed")
